...
OBJ = $(BUILD_DIR)/hipala_matrix.o $(BUILD_DIR)/hipala_vector.o $(BUILD_DIR)/test1.o 
...
$(BUILD_DIR)/hipala_vector.o: $(INC_DIR)/hipala_vector.cpp $(INC_DIR)/hipala_vector.h
	$(CC) $(CCFLAGS) $(INC_DIR)/hipala_vector.cpp -o $(BUILD_DIR)/hipala_vector.o	
